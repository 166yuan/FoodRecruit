...
<div class="col-xs-12" >
    <h3 class="header smaller lighter blue">竞赛管理</h3>
    ...
    <div>
        <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="ui-pg-div"><span class="label label-lg label-success arrowed-right">新增竞赛</span><a href="/compet/publish" target="_blank"><span
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable"
                ...
                <tr role="row">
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1"
                        colspan="1" aria-label="Domain: activate to sort column ascending">竞赛名称
                    </th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1"
                        colspan="1" aria-label="Domain: activate to sort column ascending">发布时间
                    </th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1"
                        colspan="1" aria-label="Domain: activate to sort column ascending">竞赛时间
                    </th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1"
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd">
                        ...
                        <td class=" "><a href="/compet/getById?id=${compet.id}">${compet.name}</a></td>
                        <td class=" ">${compet.createTime}</td>
                        <td class=""><fmt:formatDate  value="${compet.beginTime}"  pattern="yyyy-MM-dd" />-<fmt:formatDate  value="${compet.endTime}"  pattern="yyyy-MM-dd" /></td>
                        <td class=" ">
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="/compet/update?id=${compet.id}">
                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                </a>

                                <a class="red" href="#" onclick="deleteCompet(${compet.id})">
