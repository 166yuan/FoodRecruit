    ...
    <div>
        <form   class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="name" value="${exper.name}" id="name" placeholder="name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="hidden" id="hcontent" value="${exper.information}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="hidden" id="hrequirement" value="${exper.requirement}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="linkname" value="${exper.contact}" id="linkman" placeholder="linkman" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="phone" id="phoneNumber" value="${exper.phone}" placeholder="phoneNumber" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="qq"  value="${exper.QQ}" placeholder="QQ" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="email" class="form-control" name="email" value="${exper.email}" id="Email" placeholder="Email">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="count" value="${exper.count}" id="count" placeholder="count" >
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-4 control-label">备注</label>
                <div class="col-sm-5">
                    <textarea class="form-control" rows="5" name="note" id="remark" value="${exper.note}" placeholder="remark"></textarea>
                    `    </div>
            </div>
            ...
            <div class="form-group  ">
                <div class="col-sm-offset-6 col-sm-6">
                    <input type="button" class="btn btn-default" value="确认发布" onclick="">
                </div>
            </div>
        </form>
...
function(){
    ...
    var hrequirement=document.getElementById('hrequirement').value;
    var information=document.getElementById('content');
    var requirement=document.getElementById('requirement');
    information.innerHTML=hcontent;
    requirement.innerHTML=hrequirement;
