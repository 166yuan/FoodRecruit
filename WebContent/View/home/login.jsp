            ...
            <div id="login-box" class="login-box visiable widget-box no-border visible">
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form action="/foodrecruit/home/login" id="login" method="post">
                            <fieldset>
                                <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="username" class="form-control" placeholder="学号或者工号">
															<i class="icon-user"></i>
														</span>
                                </label>
            ...
            <div id="signup-box" class="signup-box widget-box no-border ">
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form action="/foodrecruit/home/register" method="post">
                            <fieldset>
                                <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="account" class="form-control" placeholder=学号">
															<i class="icon-user"></i>
														</span>
                                </label>
