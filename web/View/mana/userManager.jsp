...
<div class="col-xs-12">
    ...
    <div>
        <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <div class="row">
                <div class="col-xs-6">
                    <div id="sample-table-2_length" class="dataTables_length"><span class="label label-lg label-success arrowed-right">注册用户</span><span
                            class="ui-icon ace-icon fa fa-plus-circle purple" id="addUser"></span></div>
                </div>
                <div class="col-xs-6">
