        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center">
                        <h1>
                            <div class="center"><img src="/images/logo.png" height="90px;" width="399px;"/></div>
                        </h1>
                    </div>
                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="account"  id="login-account" class="form-control" placeholder="学号" />
                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="/user/register" id="register" method="post">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="repeat" class="form-control" class="form-control" placeholder="重复密码" />
...
<script type="text/javascript">
  /*  $(function(){
        ...
        $.backstretch(["/images/4.jpg"]);  //背景
        $(".other").backstretch(["/images/1.jpg","/images/3.jpg"],{fade: 1000,
            duration: 3000});  //元素背景，切换现实
    });*/
  $.backstretch([
      "/images/4.jpg",
      "/images/1.jpg",
